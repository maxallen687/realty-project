        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/machadoimoveisrs" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-brand-orange flex items-center justify-center transition-colors font-bold text-xs" aria-label="Instagram: @machadoimoveisrs">
                IG
              </a>
